...
const SAMPLE_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: '$120.00',
    rating: 5,
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBjJsktr-nu1udHmC4k3LlaP47iY4MRHRU1aPjvhrzJTIFq39Tli6QPVr0mJubvP23yQevmpbTsk6Gn-nbUUHNHhRa_-WuJUse_hjzCwoLAgOjiiGxt9aRsxQhFfzNtxWidEbOUYkXwlvyO9tFrXPfw_1FJoDAyJECwZGbOO9EisIGGpqCmWzhDNJGW0c6shqoPD0TQp121GslPnDui5tcobMNJmMcTgR3A8LgnmLsFRsijQFc6Jx5a9hVmwftAyVj3Lnm5LqCZMuB',
  },
  {
    id: 6,
...
export default function ProductListGridImpl() {
  const renderStars = (rating: number) => {
    return Array.from({ length: 5 }).map((_, i) => {
      ...
      const half = i < rating && !Number.isInteger(rating);
      return (
        <span
          key={i}
          className={`material-symbols-outlined text-[20px] ${filled || half ? 'text-tertiary' : 'text-outline-variant'}`}
          style={{ fontVariationSettings: `'FILL' ${filled ? 1 : half ? 0.5 : 0}` }}
        >
          star
        </span>
      );
        ...
        >
          ...
          <div className="p-md flex flex-col flex-1">
            ...
            <p className="text-on-surface-variant text-body-md line-clamp-2 mb-md">
              {[
                'Cedarwood and sage infused natural cleanser for gentle daily restoration.',
                'Hand-poured soy wax with notes of eucalyptus and fresh linen for morning clarity.',
                'Vitamin C and hyaluronic acid concentrate for luminous, hydrated skin.',
                'Waffle-weave organic linen towels for superior absorption and rapid drying.',
                'Ultrasonic ceramic diffuser with 8-hour runtime and soft ambient glow.',
                'Recycled merino wool slippers for ultimate breathable warmth and comfort.',
              ][product.id - 1]}
            </p>
